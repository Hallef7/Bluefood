...
public class RestauranteService {
	...
	public void saveRestaurante(Restaurante restaurante) throws ValidationException {
		...
		if (restaurante.getId() != null) {
			/* metodo que busca o cliente no banco de dados (Repository) retorna restaurante. orElseTrow caso nao encontre no BD retorna uma exceção de erro*/
			Restaurante restauranteDB = restauranteRepository.findById(restaurante.getId()).orElseThrow();
			restaurante.setSenha(restauranteDB.getSenha());
			
			
		/* caso pule para o else vai para criação de uma nova senha, entra no metodo save(restaurante) salvando nova senha criptografada No BD*/	
		}else {
	...
	/*Método que retorna os restaurante*/
